...
# Name: Marco Flores
# Date: 2017-12-13
# Description: 02 Sort Comparisons and Swaps
######################################################################################################################
...
comparisons, swaps = bubbleSort(list)
...
comparisons, swaps = optBubbleSort(list)
...
comparisons, swaps = selectionSort(list)
# prints the list after the bubble sort
...
comparisons, swaps = insertionSort(list)
